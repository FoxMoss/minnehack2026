...
// include: /tmp/tmpx02txhd1.js
  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = '../fly/fly.data';
      var REMOTE_PACKAGE_BASE = 'fly.data';
    ...
    for (var file of metadata['files']) {
      ...
      async function processPackageData(arrayBuffer) {
        ...
        Module['removeRunDependency'](`fp ${name}`);
          ...
          Module['removeRunDependency']('datafile_../fly/fly.data');
      }
      Module['addRunDependency']('datafile_../fly/fly.data');
    ...
    loadPackage({"files": [{"filename": "/CollectibleBoard.glb", "start": 0, "end": 19984}, {"filename": "/CollectibleGear.glb", "start": 19984, "end": 36336}, {"filename": "/GasCan.glb", "start": 36336, "end": 93528}, {"filename": "/PUSHILIN_PLANE.png", "start": 93528, "end": 354722}, {"filename": "/PUSHILIN_Plane.mtl", "start": 354722, "end": 354984}, {"filename": "/PUSHILIN_Plane.obj", "start": 354984, "end": 481505}, {"filename": "/Propeller.glb", "start": 481505, "end": 499533}, {"filename": "/Truck.glb", "start": 499533, "end": 930877}, {"filename": "/cubemap.fs", "start": 930877, "end": 931478}, {"filename": "/cubemap.vs", "start": 931478, "end": 931927}, {"filename": "/gear_collect.mp3", "start": 931927, "end": 945367}, {"filename": "/intenseMusic.mp3", "start": 945367, "end": 1971038}, {"filename": "/minneapolis.stl", "start": 1971038, "end": 1971172}, {"filename": "/skybox.exr", "start": 1971172, "end": 72913765}, {"filename": "/skybox.fs", "start": 72913765, "end": 72914537}, {"filename": "/skybox.jpg", "start": 72914537, "end": 73577242}, {"filename": "/skybox.vs", "start": 73577242, "end": 73577807}], "remote_package_size": 73577807});

  })();

// end include: /tmp/tmpx02txhd1.js
// include: /tmp/tmp8fae_mrd.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmp8fae_mrd.js
// include: /tmp/tmp5dm4psc7.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmp5dm4psc7.js
...
var ASM_CONSTS = {
 ...
 233261: ($0) => { return miniaudio.get_device_by_index($0).webaudio.sampleRate; },  
 233327: ($0) => { var device = miniaudio.get_device_by_index($0); if (device.scriptNode !== undefined) { device.scriptNode.onaudioprocess = function(e) {}; device.scriptNode.disconnect(); device.scriptNode = undefined; } if (device.streamNode !== undefined) { device.streamNode.disconnect(); device.streamNode = undefined; } device.webaudio.close(); device.webaudio = undefined; device.pDevice = undefined; },  
 233720: ($0) => { miniaudio.untrack_device_by_index($0); },  
 233763: ($0) => { var device = miniaudio.get_device_by_index($0); device.webaudio.resume(); device.state = miniaudio.device_state.started; },  
 233888: ($0) => { var device = miniaudio.get_device_by_index($0); device.webaudio.suspend(); device.state = miniaudio.device_state.stopped; },  
 234014: () => { if (document.fullscreenElement) return 1; },  
 234060: () => { return document.getElementById('canvas').width; },  
 234112: () => { return parseInt(document.getElementById('canvas').style.width); },  
 234180: () => { document.exitFullscreen(); },  
 234207: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 234280: () => { if (document.fullscreenElement) return 1; },  
 234326: () => { return document.getElementById('canvas').width; },  
 234378: () => { return screen.width; },  
 234403: () => { document.exitFullscreen(); },  
 234430: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 234563: () => { return window.innerWidth; },  
 234589: () => { return window.innerHeight; },  
 234616: () => { if (document.fullscreenElement) return 1; },  
 234662: () => { return document.getElementById('canvas').width; },  
 234714: () => { return parseInt(document.getElementById('canvas').style.width); },  
 234782: () => { if (document.fullscreenElement) return 1; },  
 234828: () => { return document.getElementById('canvas').width; },  
 234880: () => { return screen.width; },  
 234905: () => { return window.innerWidth; },  
 234931: () => { return window.innerHeight; },  
 234958: () => { if (document.fullscreenElement) return 1; },  
 235004: () => { return document.getElementById('canvas').width; },  
 235056: () => { return screen.width; },  
 235081: () => { document.exitFullscreen(); },  
 235108: () => { if (document.fullscreenElement) return 1; },  
 235154: () => { return document.getElementById('canvas').width; },  
 235206: () => { return parseInt(document.getElementById('canvas').style.width); },  
 235274: () => { document.exitFullscreen(); },  
 235301: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 235359: () => { return screen.width; },  
 235384: () => { return screen.height; },  
 235410: () => { return window.screenX; },  
 235437: () => { return window.screenY; },  
 235464: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 235517: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 235588: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 235645: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 235901: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 235972: () => { if (document.fullscreenElement) return 1; },  
 236018: () => { return window.innerWidth; },  
 236044: () => { return window.innerHeight; },  
 236071: () => { if (document.pointerLockElement) return 1; }
};

// Imports from the Wasm binary.
var _send_inputs = Module['_send_inputs'] = makeInvalidEarlyAccess('_send_inputs');
var _get_inputs = Module['_get_inputs'] = makeInvalidEarlyAccess('_get_inputs');
...
function assignWasmExports(wasmExports) {
  assert(typeof wasmExports['send_inputs'] != 'undefined', 'missing Wasm export: send_inputs');
  assert(typeof wasmExports['get_inputs'] != 'undefined', 'missing Wasm export: get_inputs');
  ...
  _send_inputs = Module['_send_inputs'] = createExportWrapper('send_inputs', 1);
  _get_inputs = Module['_get_inputs'] = createExportWrapper('get_inputs', 0);
